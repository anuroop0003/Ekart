...
export default function Categories() {
  ...
  return (
    <div className='relative w-full px-2.5 py-10 sm:py-14 rounded-lg flex gap-10 flex-wrap justify-center'>
      {categories.map((item) => (
        <div key={item} className='flex flex-auto flex-col justify-center h-full min-w-[150px] max-w-[150px] shadow-sm p-[10px] bg-slate-200 rounded-lg hover:bg-yellow-200 hover:cursor-pointer'>
